...
*/
    ...
    function repositorio<T extends string|number>(){         //function repositorio(){
        let dados: T;                                            //let dados: number | string;

        function getDados(){                                //function getDados(){
            return dados;                                       //return dados;     
        }                                                    //}
function setDados(novoDado: T){                            //function setDados(novoDado: number | string){
    dados = novoDado;                                          // dados = novoDado;
}                                                          //}
    return {getDados, setDados}                                //return {getDados, setDados}
    }                                                      //}

    const repositorio1 =  repositorio<string | number>();        //const repositorio1 =  repositorio();
